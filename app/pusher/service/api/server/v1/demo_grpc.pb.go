...
const (
	Demo_SendMessage_FullMethodName   = "/server.v1.demo/SendMessage"
	Demo_StreamMessage_FullMethodName = "/server.v1.demo/StreamMessage"
)
...
type DemoClient interface {
	...
	StreamMessage(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[SendMessageRequest, SendMessageResponse], error)
}
...
func (c *demoClient) SendMessage(ctx context.Context, in *SendMessageRequest, opts ...grpc.CallOption) (*SendMessageResponse, error) {
	...
	err := c.cc.Invoke(ctx, Demo_SendMessage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *demoClient) StreamMessage(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[SendMessageRequest, SendMessageResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Demo_ServiceDesc.Streams[0], Demo_StreamMessage_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type Demo_StreamMessageClient = grpc.BidiStreamingClient[SendMessageRequest, SendMessageResponse]
...
type DemoServer interface {
	...
	StreamMessage(grpc.BidiStreamingServer[SendMessageRequest, SendMessageResponse]) error
...
func (UnimplementedDemoServer) StreamMessage(grpc.BidiStreamingServer[SendMessageRequest, SendMessageResponse]) error {
...
func _Demo_SendMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Demo_SendMessage_FullMethodName,
	}
...
func _Demo_StreamMessage_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(DemoServer).StreamMessage(&grpc.GenericServerStream[SendMessageRequest, SendMessageResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Demo_StreamMessageServer = grpc.BidiStreamingServer[SendMessageRequest, SendMessageResponse]
