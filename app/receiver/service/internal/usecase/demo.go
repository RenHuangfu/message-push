...
func (d *DemoUsecase) SendMessage(ctx context.Context, p *entity.SearchNameParam) (*entity.SearchNameResult, error) {
	d.log.Infof("SendMessage")
	return d.demo.SendMessage(ctx, p)
}
