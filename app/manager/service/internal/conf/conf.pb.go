...
type Client struct {
	...
	User *Client_GRPC `protobuf:"bytes,1,opt,name=user,proto3" json:"user,omitempty"` // 对应 user.service 的客户端配置
}
...
func (x *Client) GetUser() *Client_GRPC {
	if x != nil {
		return x.User
	}
	return nil
...
type Client_GRPC struct {
	...
	Timeout  int64  `protobuf:"varint,2,opt,name=timeout,proto3" json:"timeout,omitempty"`  // 超时时间（毫秒）
}
...
func (x *Client_GRPC) GetTimeout() int64 {
	if x != nil {
		return x.Timeout
	}
	return 0
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x06, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x22, 0x54, 0x0a, 0x06, 0x53, 0x65, 0x72,
	...
	0x8a, 0x01, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x30, 0x0a, 0x08, 0x64, 0x61, 0x74, 0x61,
	...
	0x4b, 0x61, 0x66, 0x6b, 0x61, 0x52, 0x05, 0x6b, 0x61, 0x66, 0x6b, 0x61, 0x22, 0x69, 0x0a, 0x04,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0xb3,
	...
	0x65, 0x6f, 0x75, 0x74, 0x22, 0x37, 0x0a, 0x05, 0x4b, 0x61, 0x66, 0x6b, 0x61, 0x12, 0x18, 0x0a,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x22, 0x73, 0x0a,
	0x06, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x12, 0x2b, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18,
	...
	0x75, 0x73, 0x65, 0x72, 0x1a, 0x3c, 0x0a, 0x04, 0x47, 0x52, 0x50, 0x43, 0x12, 0x1a, 0x0a, 0x08,
	0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08,
	0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x74, 0x69, 0x6d, 0x65,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Client)(nil),              // 8: kratos.api.Client
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	8,  // 2: kratos.api.Bootstrap.client:type_name -> kratos.api.Client
	...
	10, // 8: kratos.api.HTTP.timeout:type_name -> google.protobuf.Duration
	10, // 9: kratos.api.GRPC.timeout:type_name -> google.protobuf.Duration
	10, // 10: kratos.api.Redis.read_timeout:type_name -> google.protobuf.Duration
	10, // 11: kratos.api.Redis.write_timeout:type_name -> google.protobuf.Duration
	9,  // 12: kratos.api.Client.user:type_name -> kratos.api.Client.GRPC
